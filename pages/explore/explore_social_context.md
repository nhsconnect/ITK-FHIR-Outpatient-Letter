...
<tbody>
  ...
  <tr>
   ...
   <td>0 to many</td>
   <td>O</td>
   <td>This is a record of the patient's current or previous occupations as volunteered by the patient or their representative or carer. Text only</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>0 to 1</td>
   <td>O</td>
   <td>This is a record of the patient's lifestyle choices which are pertinent to his or her health as volunteered by the patient. Text only.</td>
  </tr>
  <tr>
   <td>Smoking</td>
   ...
   <td>0 to 1</td>
   <td>R</td>
   <td>This is a record of the patient's attest or current smoking observation. Text only</td>
  </tr>
  <tr>
   ...
   <td>0 to 1</td>
   <td>R</td>
   <td>This is a record of the patient's attest or current alcohol consumption. Text only.</td>
  </tr>
  <tr>
